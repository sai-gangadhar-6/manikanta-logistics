...
export default function Services() {
  return (
    <section id="services" className="section-light py-16 lg:py-28">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="font-bold text-[#0F172A] text-base sm:text-lg mb-2">{service.title}</h3>
                  <p className="text-gray-500 text-sm leading-relaxed">{service.description}</p>
                </div>
                <div className="mt-5 w-8 h-0.5 bg-[#F97316] rounded-full group-hover:w-14 transition-all duration-300" />
              </motion.div>
            )
          })}
        </div>

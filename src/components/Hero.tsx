...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[100svh] lg:min-h-screen flex items-center justify-center overflow-hidden bg-[#0F172A]"
    >
      {/* Background Image */}
      <div className="absolute inset-0 z-0 bg-[#0F172A]">
        <Image
          src="/modern_indian_truck.png"
          alt="Modern white commercial container truck driving on Indian highway"
          fill
          className="object-cover opacity-35 [object-position:65%_center] lg:[object-position:center]"
          priority
          sizes="100vw"
        />
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16 lg:pt-28 lg:pb-20">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            className="mb-3 inline-flex items-center gap-2 bg-[#0F172A]/80 border border-white/20 text-white text-xs font-semibold px-4 py-2 rounded-full backdrop-blur-md shadow-md mx-auto"
          >
          ...
          <motion.div
            variants={fadeUp}
            className="mb-5 inline-flex items-center gap-2 bg-[#F97316]/20 border border-[#F97316]/40 text-[#F97316] text-xs font-semibold uppercase tracking-widest px-4 py-2 rounded-full"
          >
          ...
          >
            <a
              ...
              id="hero-call-btn"
              className="flex items-center justify-center gap-2.5 bg-[#F97316] hover:bg-[#EA6C10] text-white font-bold text-base px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-200 min-h-[52px] w-full sm:w-auto"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2.5 bg-transparent border-2 border-[#F97316] text-[#F97316] hover:bg-[#F97316] hover:text-white font-bold text-base px-8 py-4 rounded-xl hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200 min-h-[52px] w-full sm:w-auto"
            >
          ...
          {/* Trust Badges — horizontal scrolling strip on mobile */}
          <motion.div variants={fadeUp}>
            <div className="flex lg:flex-wrap lg:justify-center gap-2.5 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-1 -mx-4 px-4 lg:mx-0 lg:px-0 no-scrollbar">
              {trustBadges.map((badge) => (
                <span
                  key={badge}
                  className="flex-shrink-0 snap-start text-xs sm:text-sm font-semibold text-white bg-white/10 border border-white/20 backdrop-blur-sm px-4 py-2 rounded-full whitespace-nowrap"
                >
                  {badge}
                </span>
              ))}

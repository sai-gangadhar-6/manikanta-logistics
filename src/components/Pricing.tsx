        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 max-w-3xl mx-auto">
          {plans.map((plan, i) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className={`relative rounded-2xl p-6 sm:p-7 border-2 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                plan.highlight
            ...
            >
              ...
              <a
                ...
                className={`block w-full text-center font-bold text-sm py-4 rounded-xl transition-all duration-200 hover:scale-105 min-h-[52px] flex items-center justify-center ${
                  plan.highlight
        ...
        >
          ...
          <div className="mt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-green-500 hover:bg-green-600 text-white font-bold px-7 py-4 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200 min-h-[52px]"
            >
